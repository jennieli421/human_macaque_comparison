...
sample_fqFolder = sprintf("/home/xil4009/scratch_tilgnerlab/scisorseq_scripts/per_sample_fastq/%s_fastq/OutputFiltered", sample)
...
MMalign(fqFolder=sample_fqFolder, 
        mmProgPath=mmPath, 
        refGenome=reference, 
        numThreads=nThreads)
